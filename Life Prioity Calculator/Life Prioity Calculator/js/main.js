...
// Group 1 elements: Work Schedule, Time working on side hustles or other, and Commute Time
...
// Group 2 elements: Sleep Time and Exercise Schedule
...
function updateRemainingTime() {
  ...
  hoursPerGroupElement.innerHTML = `
    <p>Mind Hours: ${totalGroup1Hours} hours</p>
    <p>Body Hours: ${totalGroup2Hours} hours</p>
    <p>Soul Hours: ${totalGroup3Hours} hours</p>
  `;
